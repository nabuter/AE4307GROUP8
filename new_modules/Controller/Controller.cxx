...
/*      item            : Controller.cxx
	...
	from template   : DusimeModuleTemplate.cxx
        ...
        date            : Wed May 13 23:26:49 2015
	category        : body file 
        description     : 
	changes         : Wed May 13 23:26:49 2015 first version
...
//     new VarProbe<Controller,double>
//       (REF_MEMBER(&Controller::i_example))}
...
const ParameterTable* Controller::getMyParameterTable()
{
  static const ParameterTable parameter_table[] = {
    { "set-timing", 
      new MemberCall<Controller,TimeSpec>
        (&Controller::setTimeSpec), set_timing_description },

    { "check-timing", 
      new MemberCall<Controller,vector<int> >
      (&Controller::checkTiming), check_timing_description },
...
Controller::Controller(Entity* e, const char* part, const
  ...
  // myclock(),
  cb1(this, &Controller::doCalculation),
  do_calc(getId(), "This is the controller of the Dynamics to keep the Quadcopter stable", &cb1, ps)
{
...
bool Controller::checkTiming(const vector<int>& i)
{
  if (i.size() == 3) {
