/* ------------------------------------------------------------------   */
/*      item            : WorldViewer.cxx
        made by         : tux
	from template   : DusimeModuleTemplate.cxx
        template made by: Rene van Paassen
        date            : Wed May 13 23:35:51 2015
	category        : body file 
        description     : 
	changes         : Wed May 13 23:35:51 2015 first version
	template changes: 030401 RvP Added template creation comment
	                  060512 RvP Modified token checking code
        language        : C++
*/

#define WorldViewer_cxx
// include the definition of the module class
#include "WorldViewer.hxx"
...
// class/module name
const char* const WorldViewer::classname = "world-viewer";

// initial condition/trim table
const IncoTable* WorldViewer::getMyIncoTable()
{
...
//     new VarProbe<WorldViewer,double>
//       (REF_MEMBER(&WorldViewer::i_example))}
...
const ParameterTable* WorldViewer::getMyParameterTable()
{
  static const ParameterTable parameter_table[] = {
    { "set-timing", 
      new MemberCall<WorldViewer,TimeSpec>
        (&WorldViewer::setTimeSpec), set_timing_description },

    { "check-timing", 
      new MemberCall<WorldViewer,vector<int> >
      (&WorldViewer::checkTiming), check_timing_description },
...
// constructor
WorldViewer::WorldViewer(Entity* e, const char* part, const
		       PrioritySpec& ps) :
  ...
  // myclock(),
  cb1(this, &WorldViewer::doCalculation),
  do_calc(getId(), "This is the moduleent", &cb1, ps)
{
...
bool WorldViewer::setTimeSpec(const TimeSpec& ts)
{
...
bool WorldViewer::checkTiming(const vector<int>& i)
{
  if (i.size() == 3) {
...
// start the module
void WorldViewer::startModule(const TimeSpec &time)
{
  do_calc.switchOn(time);
}

// stop the module
void WorldViewer::stopModule(const TimeSpec &time)
{
...
void WorldViewer::fillSnapshot(const TimeSpec& ts, 
...
// declaration) if you specified to the SimulationModule that the size of 
// state snapshots is zero
void WorldViewer::loadSnapshot(const TimeSpec& t, const Snapshot& snap)
{
...
// appropriate output
void WorldViewer::doCalculation(const TimeSpec& ts)
{
...
void WorldViewer::trimCalculation(const TimeSpec& ts, const TrimMode& mode)
{
...
static TypeCreator<WorldViewer> a(WorldViewer::getMyParameterTable());
